...
const int base_digits = digits(base);

const int fft_base = 10'000;  // fft_base^2 * n / fft_base_digits <= 10^15 for double
const int fft_base_digits = digits(fft_base);
